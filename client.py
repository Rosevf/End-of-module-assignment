...
class Client:
    ...
    def connect_server(self):
        ...
        while True:
            ...
            if not self.validate_pickling_format(pickling_format):
        ...
        while True:
            ...
            if not self.validate_encrypt_option(encrypt_option):
        ...
        if pickling_format == "binary":
            self.send_dictionary_with_binary(server_socket, dictionary)
        elif pickling_format == "json":
            self.send_dictionary_with_json(server_socket, dictionary)
        elif pickling_format == "xml":
            self.send_dictionary_with_xml(server_socket, dictionary)
        ...
        self.send_text_file(server_socket, encrypt_option, key)
