...
def start_server():
    ...
    while True:
        ...
        while True:
            ...
            if not validate_print_option(print_option):
        ...
        if pickling_format == "binary":
            receive_dictionary_binary(client, print_option)
        elif pickling_format == "json":
            receive_dictionary_json(client, print_option)
        elif pickling_format == "xml":
            receive_dictionary_xml(client, print_option)
        ...
        receive_text_file(client, print_option, encrypt_option, key)
...
def receive_dictionary_binary(client, print_option):
    """
    ...
    print_dictionary(obj, print_option)


def receive_dictionary_json(client, print_option):
    """
...
def receive_dictionary_xml(client, print_option):
    """
